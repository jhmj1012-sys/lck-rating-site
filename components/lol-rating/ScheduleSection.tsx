                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="mt-4 grid gap-4 lg:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)_280px] lg:items-center">
                          <div className="rounded-[22px] border border-slate-200 bg-slate-50 px-4 py-4 text-lg font-bold text-slate-950 sm:text-xl">
                            {getTeamDisplayName(match.teamA)}
                          </div>
                          <div className="text-center text-xl font-black text-sky-600 sm:text-2xl">{match.score}</div>
                          <div className="rounded-[22px] border border-slate-200 bg-slate-50 px-4 py-4 text-left text-lg font-bold text-slate-950 sm:text-xl lg:text-right">
