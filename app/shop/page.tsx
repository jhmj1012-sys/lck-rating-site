      ...
      <div className="mx-auto max-w-5xl space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-black tracking-tight text-slate-950">코인 상점</h1>
        ...
        <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-[24px] border border-slate-200 bg-slate-50 px-5 py-5">
              <div className="text-xs font-semibold uppercase tracking-[0.18em] text-sky-700">Badge</div>
              <div className="mt-2 text-xl font-black text-slate-950">팀 배지</div>
              <p className="mt-2 text-sm leading-6 text-slate-600">응원 팀을 프로필과 리더보드에 더 선명하게 보여줄 수 있는 꾸미기 영역입니다.</p>
            </div>
            <div className="rounded-[24px] border border-slate-200 bg-slate-50 px-5 py-5">
              <div className="text-xs font-semibold uppercase tracking-[0.18em] text-sky-700">Title</div>
              <div className="mt-2 text-xl font-black text-slate-950">닉네임 인장</div>
              <p className="mt-2 text-sm leading-6 text-slate-600">적중률이나 시즌 기록에 맞춘 인장을 붙여 개성을 드러낼 수 있게 준비합니다.</p>
            </div>
            <div className="rounded-[24px] border border-slate-200 bg-slate-50 px-5 py-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">프로필 카드와 페이지 분위기를 바꾸는 시즌형 테마 효과를 붙일 수 있게 확장합니다.</p>
            </div>
          </div>

          <div className="mt-6 rounded-[24px] border border-sky-100 bg-sky-50 px-5 py-4">
            <div className="text-sm font-semibold text-slate-950">구조만 먼저 연결했습니다.</div>
            <p className="mt-2 text-sm leading-6 text-slate-600">
              현재는 상점 진입 흐름과 정보 구조만 열어두고, 실제 아이템 목록과 가격은 다음 단계에서 붙이는 구성이 맞습니다.
            </p>
          </div>
        </section>
      </div>
